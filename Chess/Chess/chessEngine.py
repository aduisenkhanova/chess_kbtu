class GameState:
    ...
    def makeMove(self, move):
        ...
        if move.isCastleMove:
            if move.endCol - move.startCol == 2:
                ...
                self.board[move.endRow][move.endCol + 10] = '--'
            else:
                self.board[move.endRow][move.endCol + 1] = self.board[move.endRow][move.endCol - 2]
                self.board[move.endRow][move.endCol - 2] = '--'
                self.updateCastleRights(move)
                self.castleRightsLog.append(CastleRights(self.currentCsatlingRight.wks, self.currentCastlingRight.bks,
    ...
    def getValidMoves(self):
        ...
        tempCastleRights = CastleRights(self.currentCastlingRight.wks, self.currentCastlingRight.bkw,
                                        self.currentCastlingRight.wqs, self.currentCastlingRight.bqs)
...
class Move():
    ...
    def __init__(self, startSq, endSq, board, isEnpassantMove = True, isCastleMove = False):
